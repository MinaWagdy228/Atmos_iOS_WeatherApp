...
extension WeatherModel {
    static let dummyCities: [WeatherModel] = [
        ...
        .init(
            ...
            pressure: 1012, forecast: ForecastDayModel.dummyForecast),
        .init(
        ...
        .init(
            ...
            pressure: 1015, forecast: ForecastDayModel.dummyForecast),
        .init(
        ...
        .init(
            ...
            pressure: 1010, forecast: ForecastDayModel.dummyForecast),
        .init(
            ...
            pressure: 1007, forecast: ForecastDayModel.dummyForecast),
        .init(
            ...
            pressure: 1013, forecast: ForecastDayModel.dummyForecast),
    ]
}
